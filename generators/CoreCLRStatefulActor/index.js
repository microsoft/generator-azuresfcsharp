  ...
  writing() {
    ...
    var appPackagePath =
      this.isAddNewService == false
        ? path.join(this.props.projName, appPackage)
        : appPackage;
    ...
    var testProject = path.join(
      appPackage,
      "src",
      testClientSrcPath,
      testClientProjName + ".csproj"
    );
    var interfaceProject = path.join(
      appPackage,
      "src",
      interfaceSrcPath,
      interfaceProjName + ".csproj"
    );
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(
        path.join(appPackage, "src", serviceSrcPath, this.actorName + ".cs")
      ),
      {
        actorInterfaceNamespace: this.actorName + ".Interfaces",
        actorInterfaceName: "I" + this.actorName,
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(
        path.join(appPackage, "src", testClientSrcPath, "Program.cs")
      ),
      {
        actorInterfaceNamespace: this.actorName + ".Interfaces",
        actorInterfaceName: "I" + this.actorName,
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(
        path.join(appPackage, "src", serviceSrcPath, "ActorEventListener.cs")
      ),
      {
        actorName: this.actorName,
        authorName: this.props.authorName,
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(
        path.join(appPackage, "src", serviceSrcPath, "ActorEventSource.cs")
      ),
      {
        actorName: this.actorName,
        authorName: this.props.authorName,
    ...
    this.fs.copyTpl(
      this.templatePath(
        "testclient/testscripts/testclient" + buildScriptExtension
      ),
      this.destinationPath(
        path.join(
          appPackage,
