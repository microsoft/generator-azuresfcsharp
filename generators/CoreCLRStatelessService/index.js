...
var ClassGenerator = class extends Generator {
  ...
  writing() {
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(
        path.join(appPackage, "src", serviceSrcPath, this.serviceName + ".cs")
      ),
      {
        serviceName: serviceName,
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(
        path.join(appPackage, "src", serviceSrcPath, "ServiceEventListener.cs")
      ),
      {
        serviceName: this.serviceName,
        authorName: this.props.authorName,
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(
        path.join(appPackage, "src", serviceSrcPath, "ServiceEventSource.cs")
      ),
      {
        serviceName: this.serviceName,
        authorName: this.props.authorName,
